...
# raio_do_cicrculo = float(input("Digite o raio do círculo: "))
# area_do_circulo = math.pi * raio_do_cicrculo ** 2
# # area_do_circulo_formatada = "{:.2f}".format(area_do_circulo) - como nao fazer
