...
lista_numeros_02: list = [40, 50, 60, 70, 0, -408593, 1, 50]
lista_numeros_03: list = [40, 50, 60, 70, 0, -408593, 1, 50]


def ordenar_lista_numeros(numeros: list) -> list:
    nova_lista_numeros: list = numeros.copy()
...
nova_lista_02 = ordenar_lista_numeros(lista_numeros_02)
nova_lista_03 = ordenar_lista_numeros(lista_numeros_03)
